...
Given an integer array nums and integer val, remove all occurences of val in nums "in-place". The order of the elements may be changed.
Then return the nummber of elements in nums which are not equal to val.
...
a= [3, 2, 2, 3]
print(removeElement(nums=a, val = 3))
